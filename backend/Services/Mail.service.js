...
async sendMail(scheduler_email_id, status, customMessage, appointee_name, appointment_time, appointment_date, appointment_duration, appointment_location,appointee_email_id) {
    try {
        let text;
        if(status === "confirmed"){
