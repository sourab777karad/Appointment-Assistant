...
export function TeachersList() {
	...
	return (
		<div className="bg-white border-2 border-black rounded-lg neumorphic p-4">
			<h2 className="text-2xl  mb-4 flex justify-center items-center">
				Teacher Catalogue
			</h2>
			<div className="p-1 border-2 rounded-lg border-black">
				<div className="bg-white border-black rounded-lg neumorphic p-4 max-h-80 overflow-scroll">
