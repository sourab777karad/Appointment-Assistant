...
const SideNav = () => {
  ...
  const [receivedSocketNotification, setReceivedSocketNotification] =
    React.useState(0);
  ...
  useEffect(() => {
    ...
    refreshLoggedInUserScheduleForDisplayedWeek();
    toast.success(
      "You have unread Notifications! Please check them in the Notifications tab.",
    );
                        ...
                        <div className="flex flex-row-reverse justify-between px-4 py-4 bg-gray-100 rounded-lg m-2">
                          ...
                          <div>
                            ...
                            <div className="text-blue-900 text-sm pt-1">
                              +91 {appointment.concerned_party?.phone_number}
                            </div>
                          </div>
                        </div>
                        <div className="p-2">
                        ...
                        <div className="flex flex-row-reverse justify-between px-4 py-4 bg-gray-100 rounded-lg m-2">
                          {
                            ...
                            basic_functions.get_people_from_appointment(
                              appointment,
                              allUsers,
                            )?.scheduler?.profile_pic_url.length !== 0 ? (
                              <img
                                src={
                                  basic_functions.get_people_from_appointment(
                                    appointment,
