...
export default function Schedule({
  ...
  function checkDivInSchedule(time_slot, date) {
    ...
    if (given_appointments.length === 1) {
      ...
      our_appointment.concerned_party =
        get_names_from_appointment(our_appointment).scheduler;
                    ...
                    <td
                      ...
                      className={
                        ...
                        (current_div_schedule?.type === "blocked"
                          ? " bg-red-100 "
                          : "") +
                        (current_div_schedule?.type === "Taken and Confirmed"
                          ? " bg-blue-200 "
                          : "") +
                        ...
                        "Pending Their Confirmation"
                          ? " bg-yellow-200 "
                          : "") +
                        (current_div_schedule?.type === "Given and Confirmed"
                          ? " bg-blue-200 "
                          : "") +
                        (current_div_schedule?.type ===
                      ...
                      onContextMenu={(e) => {
                        ...
                        if (
                          ...
                          if (
                            ...
                            current_div_schedule?.status === "completed" ||
                            current_div_schedule?.status === "rejected" ||
                            current_div_schedule?.status === "cancelled" ||
                            current_div_schedule?.status === "confirmed" ||
                            current_div_schedule?.type === "Multiple Requests"
                          ) {
                            handleContextMenuDisabled(e);
                            return;
                          }
                          handleAppointmentContextMenu(e, current_div_schedule);
                        }
                        handleContextMenuDisabled(e);
                      }}
                      onClick={() => {
                        ...
                        if (
                          ...
                          document.getElementById("notif-drawer").checked =
                            true;
                          return;
                        }
                    ...
                    >
                      <div className="flex flex-col justify-center items-center text-sm font-semibold">
                        <div className="flex justify-center text-center w-full">
                          {current_div_schedule?.concerned_party?.full_name}
                        </div>
