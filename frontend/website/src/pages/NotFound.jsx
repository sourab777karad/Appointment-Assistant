				...
				<div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
					<div className="max-w-md">
						...
						<p className="mb-8 mt-2">
							But dont worry, you can find plenty of other things on the Homepage of Attendance Assistant! Either contact one of the developers at MIT WPU, or go back to the homepage.
						</p>
						<button
